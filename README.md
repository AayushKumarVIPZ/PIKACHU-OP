...
Can be found on telegram as [Pikachu_lava_bot](https://t.me/Dangerx_VIPbot).

The Support group can be reached out to at [Eagle union Support](https://t.me/Pikachu_Support), where you can ask for help about [Pikachu_lava_bot](https://t.me/Dangerx_VIPbot), discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
